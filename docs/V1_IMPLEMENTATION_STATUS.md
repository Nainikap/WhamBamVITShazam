...
| Branch from historical commit and safe local replacement | clean branch-from-revision switches HEAD/INDEX/WORKING together; the confirmed replacement action writes the selected immutable snapshot into local WORKING, resets staged state, and preserves history/media | application integration and packaged Electron Playwright | Automated |
