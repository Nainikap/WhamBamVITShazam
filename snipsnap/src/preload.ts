...
const api: SnipSnapApi = {
  ...
  importKdenliveOtio: () => ipcRenderer.invoke(channels.importKdenliveOtio),
  addKdenliveFolder: () => ipcRenderer.invoke(channels.addKdenliveFolder),
  refreshKdenliveFolders: () => ipcRenderer.invoke(channels.refreshKdenliveFolders),
  openInKdenlive: (projectId, revision) => ipcRenderer.invoke(channels.openInKdenlive, projectId, revision),
  ...
  compareWorkspaceTimelines: (projectId, scope, expectedHead, expectedIndexDigest, expectedWorkspaceVersion) => ipcRenderer.invoke(
